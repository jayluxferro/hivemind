...
_SCHEMA_DDL = (
    ...
    END $$;
    """,
    # SPEC §3 DDL, corrected for fresh-only tokens_in (module docstring): the
    # original formula subtracted cache_write+cache_read from tokens_in,
    # which presumed tokens_in was TOTAL input — with fresh-only semantics
    # that double-subtracted (under-charging cache-hit rows) and went
